...
local Utility = {}
local Objects = {}
function ExPi:DraggingEnabled(frame, parent)
...
function ExPi.CreateLib(ExPiName, themeList)
    ...
    local selectedTab 
    ExpName = ExpiName or "Library"
    table.insert(ExPi, ExPiName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == ExPiName then
            v:Destroy()
        end
    end
    ...
    ExPi:DraggingEnabled(MainHeader, Main)
    ...
    function ExPi:ChangeColor(prope,color)
